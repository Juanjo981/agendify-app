// Interfaces have been extracted to ./models/paciente.model.ts
// This file now only contains mock data.
export type { AdjuntoMeta, NotaDto, CitaResumenDto, PacienteDto, SesionPaciente, HistorialTipoEvento, HistorialEvento } from './models/paciente.model';
import { PacienteDto, SesionPaciente } from './models/paciente.model';
